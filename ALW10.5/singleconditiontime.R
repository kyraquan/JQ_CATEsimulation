...
for (i in 1:NumIter) { 
  ...
  datatest = PS_model_data(n_cluster=level2n, n_ind=level1n,ICC=ICC,tau_var=tau_var,
  ...
  evalBART_df <- data.frame(
    ...
    PSmodel=PS_model,treatment_model=treatment_model,Outcomemodel=Outcome_model,tau_var=tau_var,
